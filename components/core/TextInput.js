...
export default function TextInput(props) {
  return (
    <div className="relative z-0 w-full mb-2">
      <input
        id={props.name}
        className={`block w-full pt-4 pb-1 pl-px mb-0 text-sm bg-transparent border-0 border-b appearance-none border-grey-dark focus:outline-none focus:ring-0 focus:border-violet-dark autofill:bg-transparent peer ${props.className}`}
        required
        type="text"
        name={props.name}
